...
namespace TRA.Data.Concrete.EntityFramework.Mappings
{
    public class LogMap : IEntityTypeConfiguration<Log>
    {
        public void Configure(EntityTypeBuilder<Log> builder)
        {
            ...
            builder.Property(l => l.Message).HasColumnType("varchar(65535)");
            ...
            builder.Property(l => l.Callsite).HasColumnType("varchar(65535)");

            builder.Property(l => l.Exception).IsRequired(false);
            builder.Property(l => l.Exception).HasColumnType("varchar(65535)");
